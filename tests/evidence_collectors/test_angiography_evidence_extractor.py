...
from lighten_ml.evidence_collectors.angiography_evidence_extractor import AngiographyEvidenceExtractor
...
class TestAngiographyEvidenceExtractor(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.extractor = AngiographyEvidenceExtractor(self.mock_notes_loader, llm_client=self.mock_llm_client)
    ...
    def test_regex_extraction(self):
        ...
        notes = pd.DataFrame({
            ...
            'text': ['Cardiac cath reveals a large thrombus in the left anterior descending artery.']
        })
        ...
        self.assertEqual(evidence['angiography_findings'][0]['finding'], 'Intracoronary Thrombus')
    ...
    def test_llm_extraction(self):
        ...
        llm_output = {
            'angiography_findings': [
                {'finding': 'Intracoronary Thrombus', 'context': 'thrombotic occlusion of the RCA', 'vessel': 'RCA'}
            ]
        }
