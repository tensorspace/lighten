...
from lighten_ml.evidence_collectors.clinical_evidence_extractor import ClinicalEvidenceExtractor
...
class TestClinicalEvidenceExtractor(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.extractor = ClinicalEvidenceExtractor(self.mock_notes_loader, llm_client=self.mock_llm_client)
    ...
    def test_regex_symptom_extraction(self):
        ...
        notes = pd.DataFrame({
            ...
            'text': ['Patient complains of crushing chest pain and shortness of breath.']
        })
    ...
    def test_llm_extraction(self):
        ...
        llm_output = {
            'symptoms': [{'symptom': 'Chest Pain', 'context': 'Pt reports chest tightness.', 'onset_time': '2023-03-10T08:00:00'}],
