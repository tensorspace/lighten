...
class TestOnsetDateResolver(unittest.TestCase):
    ...
    def test_priority_1_symptom_onset(self):
        ...
        evidence = {
            ...
            'ecg': {'ecg_findings': [{'charttime': '2023-01-15 09:00:00', 'mi_related': True}]},
            'troponin': {'troponin_tests': [{'timestamp': '2023-01-15 10:00:00', 'above_threshold': True}]}
        }
    ...
    def test_no_date_found(self):
        ...
        self.assertEqual(result['rationale'], 'No definitive onset date could be determined')
