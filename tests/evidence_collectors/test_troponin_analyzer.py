...
class TestTroponinAnalyzer(unittest.TestCase):
    ...
    def test_rise_and_fall_pattern(self):
        ...
        self.assertEqual(evidence['criteria_details']['criteria'], 'rise and fall pattern')
    ...
    def test_single_elevated_troponin(self):
        ...
        self.assertTrue(evidence['mi_criteria_met'])
        self.assertEqual(evidence['criteria_details']['criteria'], 'Single elevated troponin')
    ...
    def test_no_significant_change(self):
        ...
        self.assertIn('No significant rise/fall pattern', evidence['criteria_details']['reason'])
    ...
    def test_time_window_exclusion(self):
        ...
        self.assertTrue(evidence['mi_criteria_met'])
        self.assertEqual(evidence['criteria_details']['criteria'], 'Single elevated troponin')
        self.assertEqual(len(evidence['troponin_tests']), 2) # Both are still included in the list
